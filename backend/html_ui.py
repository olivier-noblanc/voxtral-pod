...
<input type="checkbox" id="albertPartial">
...
<button id="toggleS3" class="fr-btn fr-btn--secondary fr-mb-2w">Afficher/masquer S3</button>
<div id="s3Config" class="fr-grid-row fr-grid-row--gutters" style="display:none;">
                        <div class="fr-col-12 fr-col-md-6">
<input class="fr-input" type="text" id="s3Endpoint" placeholder="Endpoint">
                        </div>
                        <div class="fr-col-12 fr-col-md-6">
<input class="fr-input" type="text" id="s3Bucket" placeholder="Bucket">
                        </div>
                        <div class="fr-col-12 fr-col-md-6">
<input class="fr-input" type="password" id="s3AccessKey" placeholder="Access Key">
                        </div>
                        <div class="fr-col-12 fr-col-md-6">
<input class="fr-input" type="password" id="s3SecretKey" placeholder="Secret Key">
                        </div>
                    </div>
                </div>
