"""
Teste qu'aucune balise <style> n'est présente dans les fichiers Python du projet.
Cette règle garantit que le CSS est placé dans des fichiers *.css afin de pouvoir
...
def test_no_style_tags_in_python(py_file: pathlib.Path) -> None:
    ...
    assert matches is None, f"Balise <style> trouvée dans {py_file}"
